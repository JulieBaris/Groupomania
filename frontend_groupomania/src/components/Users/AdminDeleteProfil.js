...
function AdminDeleteProfil()
{
     ...
     UseEffectSuppUser(id, token, adminId, setUser);
     ...
     const insertText = InserDOM(SubmitDelete) 
     return insertText
}
 
export default AdminDeleteProfil;
//______________________________Utils__________________________________//
function UseEffectSuppUser(id, token, adminId, setUser) {
     useEffect(() => {
     ...
     }, [id, adminId, token, setUser]);
}

function InserDOM(SubmitDelete) {
